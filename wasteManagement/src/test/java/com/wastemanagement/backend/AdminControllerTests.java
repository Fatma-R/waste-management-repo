...
class AdminControllerTests {
    ...
    @Test
    void testServiceCreateAdmin() {
        when(adminService.createAdmin(requestDTO)).thenReturn(admin);

        Admin result = adminService.createAdmin(requestDTO);

        assert result != null;
        assert result.getFullName().equals("Super Admin");
        assert result.getEmail().equals("admin@example.com");
    ...
    void testMapperToEntityAndResponse() {
        ...
        assert mapped.getFullName().equals("Super Admin");
    ...
    void testCreateAdminController() throws Exception {
        when(adminService.createAdmin(any())).thenReturn(admin);
    ...
    void testUpdateAdminController() throws Exception {
        ...
        updated.setId("1");
        updated.setFullName("Updated Admin");
        updated.setEmail("admin@example.com");

        when(adminService.updateAdmin(eq("1"), any())).thenReturn(updated);
    ...
    void testGetAllAdminsController() throws Exception {
        ...
        when(adminService.getAllAdmins()).thenReturn(Arrays.asList(admin, admin2));
    ...
    void testDeleteAdminController() throws Exception {
        ...
        verify(adminService).deleteAdmin("1");
    }
}
